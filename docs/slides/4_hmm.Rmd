...
+ Main difference is that Nimble does not guess, we need to specify dimensions of vectors and matrices. 
...
+ Infering the latent states $z$ can be useful to estimate the prevalence of a states, e.g. in animal epidemiology and [the prevalence of a disease](https://veterinaryresearch.biomedcentral.com/articles/10.1186/1297-9716-45-39), in evolutionary ecology and the [sex ratio](https://onlinelibrary.wiley.com/doi/abs/10.1002/cjs.5550360105) or in conservation biology with  [the prevalence of hybrids](https://onlinelibrary.wiley.com/doi/full/10.1002/ece3.4819?af=R).  
