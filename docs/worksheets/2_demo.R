...
#' ## Introduction
#' 
#' In this demo, we show a simple example of how to use nimble. We use the survival example with $y = 19$ alive individuals out of $n = 57$ released. A binomial likelihood is assumed, with a beta prior on survival. 
#' 
#' ## Prepare everything 
#' 
