...
knitr::include_graphics(here::here("slides/img/gull.jpg"))
```
]

.pull-right[
```{r, echo=FALSE, out.width="110%"}
knitr::include_graphics(here::here("slides/img/bighorn.png"))
```
]
...
.pull-left[
```{r, echo=FALSE, out.width="90%"}
knitr::include_graphics(here::here("slides/img/lynx.png"))
```
]

.pull-right[
```{r, echo=FALSE, out.width="120%"}
knitr::include_graphics(here::here("slides/img/bearscat.png"))
```
]
...
+ Non-identifiability in a Bayesian framework by [Gimenez et al. (2009)](https://oliviergimenez.github.io/pubs/Gimenezetal2009-weakidentifiability.pdf) and [book by Cole (2020)](https://www.routledge.com/Parameter-Redundancy-and-Identifiability/Cole/p/book/9781498720878). 