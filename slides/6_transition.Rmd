...
+ Another constraint is that the sum of three probabilities of departure rom a given site should be one. 
...
\hspace{-1.2em}
\begin{matrix}
    z_t=I & z_t=O & z_t=D \\ \hdashline
\phi (1-\psi_{IO}) & \phi \psi_{IO} & 1 - \phi\\ 
\phi \psi_{OI} & \phi (1-\psi_{OI}) & 1 - \phi\\ 
0 & 0 & 1
\end{matrix}
\hspace{-0.2em}
\begin{matrix}
