...
+ I really wish the workshop would be in Montpellier to show you the city wonders and its surroundings.  
...
+ Instead, we'll be spending quality time on Zoom, and Slack as well. 
...
+ Everything started in January this year, on Twitter, when I asked who would be interested in a workshop on Bayesian capture-recapture. 
...
+ And here we're are, a few months later, with near 600 folks who registered. 
...
library(cowplot)
p1 <- ggdraw() + 
  draw_image(here::here("slides","img","chloe.jpg"), scale = 0.9) + 
  draw_label(label = "Chloe Rebecca Nater", hjust = -.4)

p2 <- ggdraw() + 
  draw_image(here::here("slides","img","sarah.jpg"), scale = 0.9) + 
  draw_label(label = "Sarah Cubaynes", hjust = -.5)

p3 <- ggdraw() + 
  draw_image(here::here("slides","img","maud.png"), scale = 0.9) + 
  draw_label(label = "Maud Quéroué", hjust = -.5)

p4 <- ggdraw() + 
  draw_image(here::here("slides","img","perry.jpg"), scale = 0.9) + 
  draw_label(label = "Perry de Valpine", hjust = -.5)

p5 <- ggdraw() + 
  draw_image(here::here("slides","img","olivier.jpg"), scale = 0.85) + 
  draw_label(label = "Olivier Gimenez", hjust = -.5)
...
+ With 600 attendees, I was feeling a bit alone to run this workshop on my own.
+ Several friends have agreed on joining the venture.
+ We will be 5 teachers with you today and tomorrow.  
...
+ Feel free to ask questions in Slack. We'll do our best to answer live or soon after the workshop. 
+ The idea would be to gather questions and answers in a Frequently Asked Questions section of the website. 
+ Try to use Slack for questions, and not the Zoom chat. 
+ It will easier for us to save questions and answers from Slack than Zoom. 
+ Let's have a look to the Slack we've created for the workshop. 
+ There is a specific channel for each module.
