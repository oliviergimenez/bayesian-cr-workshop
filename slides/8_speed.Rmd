...
+ Twice as fast as the standard formulation with explicit latent states. 
...
+ The run is damn fast. Also allows fitting models to big datasets. More details in dedicated Worksheet.
