...
---
## Open the hood, and change samplers
...
+ Rewrite the model.
    ...
    + Vectorize to improve computational efficiency
    + Marginalize to remove parameters

--

+ Write new samplers that take advantage of particular model structures (advanced, not covered).
...
+ [TO BE DONE] Re-run a CJS example and a multistate/multievent example.

---
## Weighted likelihood w/ unique capture history

+ [TO BE DONE] Try Perry's suggestions.

+ [TO BE DONE] Show Chloe's code for CJS model.

+ [TO BE DONE] Adapt Chloe's code for dHMM and re-run multistate/multievent example we run before.
