...
+ Add stuff here, and say that we'll see more advanced use as the workshop goes.
+ Explain workflow
+ Distinguish data and constants, remontrer exemple survival
+ Distribution
+ Vectoriser pour aller plus vite
+ Etc
...
+ Do we need to introduce advanced stuff here? Or later on progressively? 
