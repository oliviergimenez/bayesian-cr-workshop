...
df2 <- data.frame(x = 1:steps, y = theta.post2)
  ggplot() +
  geom_line(data = df, aes(x = x, y = y), size = 1.5, color = "darkgreen") + 
...
In blue: posterior mean; in red: maximum likelihood estimate.
...
.center[
```{r, fig.align = 'center', echo = FALSE, out.width = "450cm"}
knitr::include_graphics(here::here("slides/img","mixing.png"))
```
]
