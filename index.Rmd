...
**How**: Through a combination of lectures and live demonstrations, you will get acquainted with the Bayesian approach, MCMC methods and the `R` `Nimble` package to fit single-site, multi-site, multi-state and multi-event models to capture-recapture data. 
